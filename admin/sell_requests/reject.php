...
if($req['status']!=='Pending'){ flash_set('err','Only Pending can be rejected.'); redirect_to('admin/sell_requests/index.php'); }

if($_SERVER['REQUEST_METHOD']==='POST'){
  $reason=trim($_POST['reason'] ?? '');
  if($reason===''){ flash_set('err','Reject reason required.'); redirect_to('admin/sell_requests/reject.php?id='.$id); }
...
<div class="container my-4">
  <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
    <div><h3 class="fw-bold mb-1">Reject Sell Request</h3><p class="text-muted mb-0"><?php echo esc($req['car_title']); ?></p></div>
    <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/sell_requests/index.php">Back</a>
  </div>
