...
<div class="container-fluid my-4 px-3 px-md-4">
  <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
    <div><h3 class="fw-bold mb-1">Order #<?php echo (int)$order['id']; ?></h3><p class="text-muted mb-0">Details + receipt.</p></div>
    ...
    <div class="col-lg-6">
      <div class="card card-soft h-100">
        <div class="card-body">
          ...
          <div class="text-muted small"><?php echo esc($order['brand'].' '.$order['model']); ?> • <?php echo (int)$order['car_year']; ?></div>
