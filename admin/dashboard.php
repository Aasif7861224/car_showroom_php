...
<div class="container-fluid my-4 px-3 px-md-4">
  ...
  <p class="text-muted mb-3">Overview of showroom operations and recent activity.</p>
  ...
  <div class="row g-3 mt-1">
      ...
      <div class="card card-soft h-100">
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap gap-2">
            ...
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/analytics/dashboard.php">Analytics</a>
          </div>
          <div class="text-muted small mt-3">Draft cars are hidden from users. Publish only after images/details.</div>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-4">
      <div class="card card-soft h-100">
        <div class="card-body">
          <h5 class="fw-bold">Recent Sell Requests</h5>
