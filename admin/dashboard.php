...
<div class="container-fluid my-4 px-3 px-md-4">
  <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
    ...
    <div class="text-muted small">
      Server: <span class="fw-semibold">127.0.0.1:4306</span>
    </div>
  </div>
  ...
  <div class="row g-3 mt-2">
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        ...
        <div class="h4 mb-0"><?php echo $kpi['cars']; ?></div>
      </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        <div class="small text-muted">Categories</div>
        <div class="h4 mb-0"><?php echo $kpi['categories']; ?></div>
      </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        <div class="small text-muted">Customers</div>
        <div class="h4 mb-0"><?php echo $kpi['customers']; ?></div>
      </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        <div class="small text-muted">Sell Requests</div>
        <div class="h4 mb-0"><?php echo $kpi['sell']; ?></div>
      </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        <div class="small text-muted">Orders</div>
        <div class="h4 mb-0"><?php echo $kpi['orders']; ?></div>
      </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
      <div class="card card-soft p-3 h-100">
        <div class="small text-muted">Inquiries</div>
        <div class="h4 mb-0"><?php echo $kpi['inquiries']; ?></div>
      </div>
    </div>
  </div>
      ...
      <div class="card card-soft h-100">
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap gap-2">
            ...
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/categories.php">Categories</a>
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/users.php">Users</a>
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/sell_requests.php">Sell Requests</a>
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/orders.php">Orders</a>
            <a class="btn btn-outline-dark" href="<?php echo BASE_URL; ?>admin/inquiries.php">Inquiries</a>
          </div>

          <div class="text-muted small mt-3">
            Tip: Draft cars are hidden from users. Publish only after adding images & details.
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card card-soft h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a class="small text-decoration-none" href="<?php echo BASE_URL; ?>admin/sell_requests.php">View all</a>
          </div>
              ...
              <tbody>
                <?php foreach($recent as $r): ?>
                  <tr>
                    ...
                    <td class="text-end">
                      <span class="badge text-bg-<?php echo badgeSell($r['status']); ?>">
