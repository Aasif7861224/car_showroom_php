...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  flash_set('ok','Car updated successfully.');
    ...
    <div class="card-body">
      <form method="post" class="row g-3">
        ...
        <div class="col-md-8">
          ...
          <input class="form-control" name="title" required value="<?php echo esc($car['title']); ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Brand *</label>
          <input class="form-control" name="brand" required value="<?php echo esc($car['brand']); ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Model *</label>
          <input class="form-control" name="model" required value="<?php echo esc($car['model']); ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Year *</label>
          <input class="form-control" type="number" name="car_year" required value="<?php echo (int)$car['car_year']; ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Fuel *</label>
          <input class="form-control" name="fuel" required value="<?php echo esc($car['fuel']); ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Transmission *</label>
          <input class="form-control" name="transmission" required value="<?php echo esc($car['transmission']); ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Price *</label>
          <input class="form-control" type="number" name="price" required value="<?php echo (float)$car['price']; ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Mileage (km)</label>
          <input class="form-control" type="number" name="mileage_km" value="<?php echo (int)$car['mileage_km']; ?>">
        </div>

        <div class="col-md-4">
          <label class="form-label">Location *</label>
          <input class="form-control" name="location" required value="<?php echo esc($car['location']); ?>">
        </div>
        ...
        <div class="col-12">
          ...
          <textarea class="form-control" name="description" rows="4"><?php echo esc($car['description']); ?></textarea>
        </div>
