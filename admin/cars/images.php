...
$car_id = (int)(isset($_GET['id']) ? $_GET['id'] : 0);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'primary') {
    $img_id = (int)(isset($_POST['img_id']) ? $_POST['img_id'] : 0);
...
<div class="container my-4">
  <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
    <div>
      <h3 class="fw-bold mb-1">Manage Images</h3>
  ...
  <div class="card card-soft mt-3">
    <div class="card-body">
      ...
      <div class="row g-3">
              ...
              <div class="card-body">
                ...
                <div class="d-flex gap-2 mt-2">
                  <form method="post" class="w-100">
                    ...
                    <button class="btn btn-outline-success btn-sm w-100" <?php echo ((int)$im['is_primary']===1)?'disabled':''; ?>>
                      Set Primary
                    </button>
                  </form>
        ...
        <?php if(count($imgs)===0): ?>
          <div class="col-12">
            <div class="alert alert-warning">No images yet. Upload at least 1 image for best UI.</div>
          </div>
        <?php endif; ?>
      </div>
