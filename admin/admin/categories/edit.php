...
if(!$cat){ flash_set('err','Not found.'); redirect_to('admin/categories/index.php'); }
    ...
    <form method="post" class="row g-3">
      ...
      <div class="col-md-4"><label class="form-label">Active</label>
        <select class="form-select" name="is_active">
          <option value="1" <?php echo ((int)$cat['is_active']===1)?'selected':''; ?>>Yes</option>
          <option value="0" <?php echo ((int)$cat['is_active']===0)?'selected':''; ?>>No</option>
        </select>
      </div>
